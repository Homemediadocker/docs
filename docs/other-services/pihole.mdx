...
id: pihole
title: PiHole
description: PiHole is a DNS manager and network AD Blocker
sidebar_position: 1
---
...
- For more information, please refer to the [PiHole Docs](https://docs.pi-hole.net/)
...
| Type     | Command                       |
| -------- | ----------------------------- |
| Start    | `docker compose up pihole -d` |
| Shutdown | `docker compose down pihole`  |

<img src="/Home-Media-Docker/img/pihole.png" alt="pihole" />
...
| Image            | [pihole/pihole](https://hub.docker.com/r/pihole/pihole)(Docker Hub) |
