...
This error may occur inside of the emby docker container where it will not register `nvidia-smi` or any associated video cards. I reported this to `linuxserver.io` in their github as an issue here: [docker-emby:#97](https://github.com/linuxserver/docker-emby/issues/97).
