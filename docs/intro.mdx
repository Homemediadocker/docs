...
- This will install everything for you plus a media server, create all of your .env files, and fill in some of the blanks for you. Just follow the prompts. 

- This is a barebones Home Media Docker setup. What started it all. 

- If you want to modify these quick-start containers, see the [.env-example](https://github.com/Homemediadocker/Home-Media-Docker/blob/main/.env-example#L26) file and edit prior to running the quick-start. For more info, see [Docker Compose Profile Options](./getting-started/docker-info.mdx#compose-profiles) for all available features/containers and info about Compose Profiles.
