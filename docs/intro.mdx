...
In order to start using this package, you may need to make a few modifications for your usecase in the [`docker-compose.yml`](https://github.com/Homemediadocker/Home-Media-Docker/blob/main/docker-compose.yml). That file ultimately drives the entire experience.
